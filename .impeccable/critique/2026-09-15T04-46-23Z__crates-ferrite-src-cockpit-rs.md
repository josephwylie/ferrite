---
target: Ferrite full UI polish and quality audit
total_score: 24
max_score: 40
na_heuristics:
p0_count: 0
p1_count: 3
timestamp: 2026-09-15T04-46-23Z
slug: crates-ferrite-src-cockpit-rs
---
...
**22 findings: 3 P1 major, 14 P2 material refinements, 5 P3 finishing details.** This is an audit extension on `audit/full-ux-2026-09-14`, against product baseline `fbc03f3`. No product code or UI was changed. Documentation, unmodified synthetic screenshots, computed evidence and unapplied capture patches are the deliverables. The [earlier 42-finding functional audit](../../docs/audits/2026-09-14-full-ux/README.md) remains separate; this report does not recast its data-loss, routing or lifecycle issues as polish findings.

Open the [screenshot gallery](../../docs/audits/2026-09-15-ui-quality/gallery.html), [full findings with source references and acceptance criteria](../../docs/audits/2026-09-15-ui-quality/findings.md), or [evidence and reproduction notes](../../docs/audits/2026-09-15-ui-quality/evidence/README.md).

## First five priorities

1. **P1 — Keep Questions inside their owning Pane.** A normal two-option Question at 1200×800 covers its Thread title and app titlebar. Constrain the whole island to available Pane space and scroll its options, preserving ownership and the action row. [UI-01](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-01), [screenshot](../../docs/audits/2026-09-15-ui-quality/screenshots/question-group-1200x800.png). Suggested follow-up: `$impeccable harden`.
2. **P1 — Render complete text rows in the compact grid.** At 860×500, ordinary four-Thread content is cut horizontally through glyphs. Spend the height on the newest complete useful rows and omit older rows whole. [UI-02](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-02), [screenshot](../../docs/audits/2026-09-15-ui-quality/screenshots/group-l2-860x500.png). Suggested follow-up: `$impeccable adapt`.
3. **P1 — Paint the keyboard target on tool disclosures.** The Tab/Enter path moves focus but the targeted control adds no visible styling. Show a distinct focused header before Enter opens it. This is source confirmed; a Tab sequence was not captured. [UI-20](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-20). Suggested follow-up: `$impeccable harden`.
4. **P2 — Make the Composer's primary actions discoverable.** Send/newline conventions are missing from the visible instructions, and interrupt is passive text. Add compact, neutral actions and clear composing guidance; keep model/effort secondary. [UI-03](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-03), [draft](../../docs/audits/2026-09-15-ui-quality/screenshots/draft-1000x800.png). Suggested follow-up: `$impeccable clarify`.
5. **P2 — Give Settings a considered control hierarchy.** Remove the repeated content heading, group provider settings, expose current model values clearly and give effort choices a shared control boundary. Its subtle native focus/hover states need verification alongside the resting redesign. [UI-04](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-04), [UI-09](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-09), [screenshot](../../docs/audits/2026-09-15-ui-quality/screenshots/settings-compact.png). Suggested follow-up: `$impeccable polish`.
...
|---|---|---|---|
| [UI-01](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-01) | P1 | Question hides owning Thread and app titlebar | Framebuffer + source |
| [UI-02](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-02) | P1 | Compact Group slices ordinary text through baselines | Framebuffer + source |
| [UI-20](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-20) | P1 | Keyboard disclosure focus has no visible target | Source call path |
| [UI-03](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-03) | P2 | No visible Send/newline route; interrupt is passive text | Framebuffer, native app, source |
| [UI-04](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-04) | P2 | Flat Settings choices and duplicated hierarchy | Framebuffer, native app, source |
| [UI-05](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-05) | P2 | Model/effort look available during a guaranteed busy refusal | Closed control frame + source |
| [UI-06](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-06) | P2 | Suggested and entered prompt text share the same treatment | Source; placeholder frame |
| [UI-07](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-07) | P2 | Main tab is an anonymous dash | Framebuffer, native app, source |
| [UI-08](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-08) | P2 | Wide Solo increases eye travel without reading scale | Two ordinary window captures |
| [UI-09](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-09) | P2 | Settings hover/focus feedback is exceptionally subtle | Native toolkit source + calculation |
| [UI-10](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-10) | P2 | Completion fades an active Composer | Framebuffer + source |
| [UI-11](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-11) | P2 | Image preview has no detail-inspection escape hatch | Source only |
| [UI-12](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-12) | P2 | Code block boundaries and direct Copy affordance are weak | Framebuffer + source |
| [UI-13](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-13) | P2 | Identical plus glyphs conceal different creation scopes | Framebuffer + source |
| [UI-19](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-19) | P2 | Enabled Project completion inherits secondary ghost style | Source; disabled empty-state frame only |
| [UI-21](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-21) | P2 | Focus paints over an alert perimeter | Framebuffer + source |
| [UI-22](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-22) | P2 | Diff line numbers and omission counts use separator ink | Source + calculation |
| [UI-14](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-14) | P3 | H1 is unrequested italic/underlined; deep headings collapse | Framebuffer + source |
| [UI-15](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-15) | P3 | Failure decoration and Escape hints repeat | Framebuffer + source |
| [UI-16](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-16) | P3 | Short commentary gets disproportionate answer padding | Framebuffer + source |
| [UI-17](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-17) | P3 | Settings has one square lower corner | Two framebuffers + pixel check |
| [UI-18](../../docs/audits/2026-09-15-ui-quality/findings.md#ui-18) | P3 | Focus removes the Composer gutter and shifts text | Source layout; static Group states |
...
**Evidence:** F = fresh production-renderer framebuffer with synthetic content; V = installed native app observation; S = source-confirmed. A screenshot can establish appearance without establishing every interaction. Source-only transitions and missing capture states are called out below. See the [gallery](../../docs/audits/2026-09-15-ui-quality/gallery.html) and [reproduction notes](../../docs/audits/2026-09-15-ui-quality/evidence/README.md).
...
**Evidence — F/V/S:** [Draft](../../docs/audits/2026-09-15-ui-quality/screenshots/draft-1000x800.png), [working Thread](../../docs/audits/2026-09-15-ui-quality/screenshots/subagents-1000x800.png), [pane.rs:2669](../../crates/ferrite/src/pane.rs#L2669), [hints at 2866](../../crates/ferrite/src/pane.rs#L2866), and [plain interrupt text at 2772](../../crates/ferrite/src/pane.rs#L2772). Existing keyboard actions work; this finding concerns affordance. The earlier interrupt/queue behavior issue remains separate.
...
**Evidence — F/V/S:** [Settings at 1000×800](../../docs/audits/2026-09-15-ui-quality/screenshots/settings-compact.png). [prefs.rs:129](../../crates/ferrite/src/prefs.rs#L129) wraps already titled groups in same-named pages; [cockpit.rs:2615](../../crates/ferrite/src/cockpit.rs#L2615) names those groups. [prefs.rs:203](../../crates/ferrite/src/prefs.rs#L203) uses 22px independent chips whose unselected RAISED ground equals the MENU ground. Measurement confirms the selected fill is only 1.18:1 against the modal, although its brighter text is visible. Missing Codex-default representation is already UX-39, not another new issue here.
...
**Evidence — F/V/S:** [Subagent tabs](../../docs/audits/2026-09-15-ui-quality/screenshots/subagents-1000x800.png), [subagents.rs:380](../../crates/ferrite/src/cockpit/subagents.rs#L380). The tooltip and accessibility label say Main transcript, but neither is a persistent visible label. This is separate from UX-36's changing owning title.
...
**Evidence — F/S:** Compare [desktop prose](../../docs/audits/2026-09-15-ui-quality/screenshots/prose-desktop.png) with [compact prose](../../docs/audits/2026-09-15-ui-quality/screenshots/prose-compact.png). [rich.rs:241](../../crates/ferrite/src/rich.rs#L241) uses full width; [theme.rs:232](../../crates/ferrite/src/theme.rs#L232) sets answer size. **Existing product intent matters:** [pane.rs:4316](../../crates/ferrite/src/pane.rs#L4316) explicitly records the operator's rejection of a 68ch cap. Full-width prose is deliberate, not an accidental regression.
...
**Evidence — F/S:** [Solo](../../docs/audits/2026-09-15-ui-quality/screenshots/prose-desktop.png). [nav.rs:438](../../crates/ferrite/src/nav.rs#L438), [titlebar.rs:121](../../crates/ferrite/src/titlebar.rs#L121), and [context-dependent behavior at cockpit.rs:6682](../../crates/ferrite/src/cockpit.rs#L6682). Tooltips do describe the actions; the issue is first-look discovery, separate from UX-18's incorrect Group context-menu behavior.
...
**Evidence — F/S:** [Formatting capture](../../docs/audits/2026-09-15-ui-quality/screenshots/formatting-wide.png); the [input fixture](../../docs/research/cli-capture-2026-09-06/model-source/claude-formatting.md) contains plain heading syntax. [Vendor node.rs:2425](../../vendor/gpui-base/src/text/node.rs#L2425) adds italic and underline to every H1; [rich.rs:330](../../crates/ferrite/src/rich.rs#L330) assigns one size to H3–H6.
...
**Evidence — F/S:** [Working and failed Group](../../docs/audits/2026-09-15-ui-quality/screenshots/group-l1-1200x800.png), [subagent/Composer hints](../../docs/audits/2026-09-15-ui-quality/screenshots/subagents-1000x800.png). [Group failure rendering](../../crates/ferrite/src/pane.rs#L4676), [child badge](../../crates/ferrite/src/pane.rs#L4480), [progress hint](../../crates/ferrite/src/pane.rs#L2451), and [Composer hint](../../crates/ferrite/src/pane.rs#L2764). Failures are synthetic fixture content, not a claim that a real test run failed.
...
**Evidence — F/S:** [Group commentary](../../docs/audits/2026-09-15-ui-quality/screenshots/group-l1-1200x800.png), [prose](../../docs/audits/2026-09-15-ui-quality/screenshots/prose-compact.png). [transcript.rs:317](../../crates/ferrite/src/transcript.rs#L317) applies answer padding; [theme.rs:596](../../crates/ferrite/src/theme.rs#L596) and [615](../../crates/ferrite/src/theme.rs#L615) set answer and block gaps.
...
**Evidence — F/S:** [Compact Settings](../../docs/audits/2026-09-15-ui-quality/screenshots/settings-compact.png), [desktop Settings](../../docs/audits/2026-09-15-ui-quality/screenshots/settings-desktop.png). [prefs.rs:52](../../crates/ferrite/src/prefs.rs#L52) rounds the outer card; [123](../../crates/ferrite/src/prefs.rs#L123) gives its inner sidebar an opaque background. The exact child-clipping mechanism was not separately reproduced.
...
**Evidence — S, static states visible in F:** [pane.rs:2708](../../crates/ferrite/src/pane.rs#L2708), [Group](../../docs/audits/2026-09-15-ui-quality/screenshots/group-l1-1200x800.png). The movement follows the conditional layout; an animated or paired identical-draft capture was not made. The exact distance depends on glyph metrics, so no measured 15px claim is made.
...
**Evidence — S/measurement:** [pane.rs:5162](../../crates/ferrite/src/pane.rs#L5162) and [5199](../../crates/ferrite/src/pane.rs#L5199) apply SEP #6e6e6e to line numbers and omission counts. The [computed ratios](../../docs/audits/2026-09-15-ui-quality/evidence/measurements.json) are 3.52:1 against the plain Pane and about 2.90–2.96:1 against added/removed washes; changed-code inks are about 8.83 and 7.53:1. These are role-specific color measurements, not a claim that all code is hard to read. No matching diff-state framebuffer is supplied in this extension.
