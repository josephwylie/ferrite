...
reader as a docked Pane beside the live Thread. Drag the seam to resize it.
Relative links resolve from the document's folder, and opening another
Markdown document replaces the reader.
